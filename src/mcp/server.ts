...
export const defaultInstructions = [
  ...
  '',
  'Express stance with the dedicated types: contradicts marks two live, mutually',
  'exclusive claims and is symmetric (A↔B) — neither side is authoritative, so never',
  'hide one endpoint; supports is directed — the source provides evidence for the target.',
  '',
